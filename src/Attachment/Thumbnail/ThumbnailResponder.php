...
class ThumbnailResponder extends PageResponder{
	...
	protected function prepare(): bool{
		...
		if ($this->getArgumentsBag()->has('config')){
			$config = $this->getArgumentsBag()->get('config');
		}else{
			$config = AttachmentRepository::Module()->getConfig($this->getArgumentsBag()->get('attachment'));
		}
