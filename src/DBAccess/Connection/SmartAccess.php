...
class SmartAccess {
	...
	public function getValues(string $sql, ...$sqlParams){ return $this->execute($sql, ...$sqlParams)->fetchAll(PDOConnection::FETCH_COLUMN, 0); }
	public function getRows(string $sql, ...$sqlParams){ return $this->execute($sql, ...$sqlParams)->fetchAll(PDOConnection::FETCH_ASSOC); }
	public function getValuesWithKey(string $sql, ...$sqlParams){ return $this->execute($sql, ...$sqlParams)->fetchAll(PDOConnection::FETCH_KEY_PAIR); }
	public function getRowsWithKey(string $sql, ...$sqlParams){ return $this->execute($sql, ...$sqlParams)->fetchAll(PDOConnection::FETCH_UNIQUE | PDOConnection::FETCH_ASSOC); }
